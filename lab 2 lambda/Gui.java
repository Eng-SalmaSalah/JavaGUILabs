    ...
    public Gui() {
        ...
        this.addWindowListener(new WindowListener(){
            ...
            public void windowClosing(WindowEvent e) {
                ...
                int option=JOptionPane.showConfirmDialog(Gui.this, "Do you want to exit?", "confirmation message",JOptionPane.YES_NO_OPTION);
                if (option==0) 
                {
                    dispose();
                }
        ...
        //elmfrod ta5od object mn l class y3ml implement ll caretListener
